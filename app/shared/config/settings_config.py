...
@dataclass
class AppSettings:
    import_app_name: str = os.getenv("IMPORT_APP_NAME", "Global Knowledge Hub Import Service")
    query_app_name: str = os.getenv("QUERY_APP_NAME", "Global Knowledge Hub Query Service")
